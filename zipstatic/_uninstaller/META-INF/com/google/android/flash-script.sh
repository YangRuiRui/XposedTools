...
rm -f /system/pmxped.prop
rm -f /system/framework/PmxpedBridge.jar
...
rm -f /system/lib/libpmxped_art.so
rm -f /system/lib/libpmxped_art.so.no_orig
if [ $IS64BIT ]; then
  ...
  rm -f /system/lib64/libpmxped_art.so
  rm -f /system/lib64/libpmxped_art.so.no_orig
fi
